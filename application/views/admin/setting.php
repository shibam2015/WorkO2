...
<div class="input-group"> <span class="input-group-addon"><i class="fa fa-facebook-official"></i></span>
...
<textarea class="form-control" id="google_map" name="google_map" style="height:150px;"><?php _e($data[0]['google_map']); ?>
</textarea>
</div>
</div>
</div>

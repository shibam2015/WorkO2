...
<div class="caption"> <i class="fa fa-gift"></i>Create Page</div>
...
<form action="<?php _e(site_url('dashboard/create-page')); ?>" method="post" class="horizontal-form">
...
<input type="text" id="page_title" name="page_title" class="form-control" value="" required placeholder="">
</div>
</div>
<div class="col-md-12">
<div class="form-group">
<label class="control-label">Page Content<span style="color:#F00">*</span></label>
<textarea class="form-control ckeditor" id="page_content" name="page_content" style="height:150px;" required></textarea>
</div>
</div>
</div>
</div>

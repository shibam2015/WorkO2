...
<div class="caption"> <i class="fa fa-gift"></i>Update Page</div>
...
<textarea class="form-control ckeditor" id="page_content" name="page_content" style="height:150px;" required><?php _e($data[0]['page_content']); ?>
</textarea>
</div>
</div>
</div>

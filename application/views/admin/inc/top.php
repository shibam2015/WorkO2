<?php $page_name = __page_name($_ci_view); ?>
<!DOCTYPE html>
...
<!-- BEGIN PAGE LEVEL PLUGINS DASHBAOARD -->
<link href="<?php echo site_url('assets'); ?>/global/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
<!-- END PAGE LEVEL PLUGINS DASHBAOARD -->
...
<!-- BEGIN THEME GLOBAL STYLES DASHBAOARD -->
...
<link href="<?php echo site_url('assets'); ?>/pages/css/login.min.css" rel="stylesheet" type="text/css" />
<link href="<?php echo site_url('assets'); ?>/global/css/sweetalert.css" rel="stylesheet" type="text/css" />
<!-- END THEME LAYOUT STYLES -->
<link rel="shortcut icon" href="../admin_1/favicon.ico" /> 
</head>
<!-- END HEAD -->

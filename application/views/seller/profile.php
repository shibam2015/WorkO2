...
<div class="update-btn" id="btn1">Update</div>
</div>
</div>
</div>
...
<div class="des-holder">
<textarea class="form-control" name="" cols="" rows="" id="seller_availability" name="seller_availability" placeholder="Please tell us about any hobbies, additional expertise, or anything else you’d like to add."><?php echo $data[0]['seller_availability'];?></textarea>
</div>
<div class="bot-area">
<div class="hide-2">Cancel</div>
<div class="update-btn" id="btn2">Update</div>
</div>
</div>
</div>
<div class="buyer-left-holder no-border">
...
<div class="update-btn2" id="btn3">Add</div>
</div>
</div>
</div>
<div class="buyer-left-holder no-border">
...
<div class="update-btn2" id="btn4">Add</div>
</div>
</div>
</div>
<div class="buyer-left-holder no-border">
...
<div class="update-btn2" id="btn5">Add</div>
</div>
</div>
</div>
<div class="buyer-left-holder no-border">
...
<div class="buyer-right-img"> <img style="max-width:100%; height:auto;" src="assets/images/img-4.png" alt="fsdf"> </div>
<div class="buyer-right-btn"> <a class="buyer-btn" href="#">Create a Gig</a> </div>
</div>
</div>
</div>
</div>

...
<div class="seller-form-holder ">
<input class="pro-select2 bor form-control" type="text" placeholder="Add a Question: i.e. Do you translate to English as well?" name="">
</div>
<div class="seller-form-holder pricing-form-holder">
<textarea class="des-text form-control" name="" cols="" rows="" placeholder="Add an Answer: i.e. Yes, I also translate from English to Hebrew."></textarea>
</div>
<div class="seller-form-holder pricing-form-holder"> <a class="cancel-btn" href="#">Cancel</a> <a class="add-btn" href="#">Add</a>
<div class="clearfix"></div>
</div>
<div class="seller-form-holder ">
